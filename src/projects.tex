\section{Projects}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\href{https://github.com/weichunnn/voice-out}{\faGithub\ \textbf{{Readabl}}} $|$ \emph{JavaScript, Python, Svelte, FastAPI, Google Cloud, BeautifulSoup, NLTK Docker}}{}
          \resumeItemListStart
            \resumeItem{Led a team of 3 to build a web app that offers readability metrics for google search results with the custom search API}
            ...
            \resumeItem{Coded Svelte components to call the backend to receive search results and display results in an accesible format}
          \resumeItemListEnd
    \resumeSubHeadingListEnd
    
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\href{https://github.com/benthecoder/Energytics}{\faGithub\ \textbf{{Energytics}}} $|$ \emph{Python, Streamlit, Pandas, Plotly, Seaborn, Scikit-learn, LightGBM, OpenWeatherMap API}}{}
          \resumeItemListStart
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\href{https://github.com/benthecoder/linkedin-visualizer}{\faGithub\ \textbf{{LinkedIn Insights}}} $|$ \emph{Python, Numpy, Streamlit, Pandas, thefuzz, Plotly, Pyvis, Networkx, NLTK, wordcloud}}{}
          \resumeItemListStart
